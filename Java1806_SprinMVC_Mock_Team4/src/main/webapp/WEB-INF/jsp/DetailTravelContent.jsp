...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <div class="sivo_block1">
      <div class="sivo_block2">
         ...
         <c:forEach items="${listTravelContentByTravelTravelId}" var="listTravelContentByTravelTravelId">
            <div class="maliChitiet">
               <h2>
             
                  <c:out value="${listTravelContentByTravelTravelId.travelContentTitle }"></c:out>
               </h2>
               <p hidden id="myParagraph">
                  <c:out value="${listTravelContentByTravelTravelId.travelContentImage }"></c:out>
               </p>
               <p>
                  <script>
               ...
               <p hidden id="myParagraph2">
                  <c:out value="${listTravelContentByTravelTravelId.travelContentShort }"></c:out>
               </p>
               <p>
                  <script>
               ...
               <p hidden id="myParagraph1">
                  <c:out value="${listTravelContentByTravelTravelId.travelContent }"></c:out>
               </p>
               <p>
                  <script>
