...
<body>
         ...
         <table
            ...
            <tr>
               <th>
                  <h4>
                     <strong>
                        Nhận đặt Tour du lịch Đà Nẵng - 
                        <c:forEach
                           items="${listTravel}" var="listTravel">
                           <a
                           href="DetailTravelContent?travelId=
                           <c:out value="${listTravel.travelId }"></c:out>
                           ">
   ...
   <div id="navigacija" class="jqueryslidemenu">
      <ul class="primary-menu">
         ...
         <li class="drop">
            <a href="#">Khách Sạn &raquo;</a>
            <ul>
               <li><a href="#">Sample Drop Down Menu</a></li>
            </ul>
         </li>
         <li class="drop">
            <a href="#">Vé Máy Bay &raquo;</a>
            <ul>
               <c:forEach items="${listPlanes}" var="listPlanes">
                  <li>
                     <a
                     href="
                     <c:out value="${listPlanes.planesLink }"></c:out>
                     ">Máy bay giá rẻ</a>
                  </li>
               </c:forEach>
            </ul>
            ...
            <div class="input-field first-wrap">
               <div class="input-select">
                  <select data-trigger="1" name="travelId">
                     <option placeholder="">-- Lựa chon điểm đến --</option>
                     <c:forEach items="${listTravel}" var="listTravel">
                        <option>
