			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="saveHome"><i class="fa fa-circle-o"></i>Tin
									trang chủ - Home</a></li>
							<li><a href="saveTravel"><i class="fa fa-circle-o"></i>Tin
									địa điểm</a></li>
							<li><a href="saveTravelContent"><i
									class="fa fa-circle-o"></i>Thông tin chi tiết địa điểm</a></li>
							<li><a href="saveSale"><i class="fa fa-circle-o"></i>Tin
									khuyễn mãi</a></li>
							<li><a href="index"><i class="fa fa-circle-o"></i>Tin
									Đặt Tour</a></li>
							<li><a href="index"><i class="fa fa-circle-o"></i>Tin
									Khách Sạn</a></li>
							<li><a href="savePlanes"><i class="fa fa-circle-o"></i>Tin
									Vé Máy Bay</a></li>
							<li><a href="saveCar"><i class="fa fa-circle-o"></i> Tin
									Xe</a></li>
						</ul></li>
