...
<div class="sivo_block1">
	<div class="sivo_block2">
		...
		<div class="maliChitiet">
			...
			<h2>
				<c:out value="${lisCarByCarId.carTitle}"></c:out>
			</h2>
			...
			<p hidden id="myParagraph2">
				<c:out value="${lisCarByCarId.carNumberPhone}"></c:out>
			</p>
			<p>
				<script>
			...
			<p hidden id="myParagraph4">
				<c:out value="${lisCarByCarId.carNameDriver}"></c:out>
			</p>
			<p>
				<script>
					var theString = document.getElementById("myParagraph4").innerHTML;
					var varTitle = $('<textarea />').html(theString).text();
					document.write(varTitle);
				</script>
			</p>
...
<!-- end sivo_block  -->
<a href="${pageContext.servletContext.contextPath}/saveBookCar?carId=${lisCarByCarId.carId}">Đặt xe</a>
<!-- end items-wrapper -->
<div class="clear"></div>
</div>
<!-- end container -->
